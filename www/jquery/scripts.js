...
// });
$(function(){
	var paginate_button = $('.page-item');
	console.log(paginate_button)
paginate_button.css("background-color", "black")

});
// Obarvení řádků tabulky
$(function(){
	var row = $('.recline');
	
row.on('mouseover',function(){
	$(this).css("background-color", "#bbd16c");
});
...
// zobrazení jedné vybrané školy
$(function(){
var row = $('.recline');
var icon = $('.leaflet-marker-icon');
console.log(icon);
row.on('click',function(){
	icon.show(id);
});
});
//datepicker pro PostForm
